...
if __name__ == '__main__':
    ...
    data_process_list = [
                            [
                                [
                                    ["./data/source/weibo/train.txt", to_sample_for_weibo, False, False],
                                    ["./data/source/douban/train.txt", to_sample_for_douban, False, False],
                                    ["./data/source/LCCC/train.json", to_sample_for_lccc, False, False],
                                    ["./data/source/duconv/train.txt", to_sample_for_duconv, True, False],
                                    ["./data/source/kdconv/train.txt", to_sample_for_kdconv, True, False],
                                    ["./data/source/tencent/train.txt", to_sample_for_tencent, True, False],
                                    ["./data/source/DuRecDial/train.txt", to_sample_for_durecdial, True, False],
                                    ["./data/source/Persona/train.json", to_sample_for_persona, True, False],
                                    ["./data/source/Emotional/train.txt", to_sample_for_emotional, True, False]
                                ],
                                "./data/train.txt",
                                50000,
                            ],
                            [
                                [
                                    ["./data/source/weibo/dev.txt", to_sample_for_weibo, False, False],
                                    ["./data/source/douban/dev.txt", to_sample_for_douban, False, False],
                                    ["./data/source/LCCC/dev.json", to_sample_for_lccc, False, False],
                                    ["./data/source/duconv/dev.txt", to_sample_for_duconv, True, False],
                                    ["./data/source/kdconv/dev.txt", to_sample_for_kdconv, True, False],
                                    ["./data/source/tencent/dev.txt", to_sample_for_tencent, True, False],
                                    ["./data/source/DuRecDial/dev.txt", to_sample_for_durecdial, True, False],
                                    ["./data/source/Persona/dev.json", to_sample_for_persona, True, False],
                                    ["./data/source/Emotional/dev.txt", to_sample_for_emotional, True, False]
                                ],
                                "./data/dev.txt",
                                5000,
                            ],
                            [
                                [
                                    ["./data/source/duconv/test.txt", to_sample_for_duconv, True, True],
                                    ["./data/source/DuRecDial/test.txt", to_sample_for_durecdial, True, True],
                                    ["./data/source/Persona/test.json", to_sample_for_persona, True, True],
                                ],
                                "./data/test.txt",
                                0
                            ],
