...
"""Classification Reader for input with entity-augmentaton."""

from collections import namedtuple

from knover.data.classification_reader import ClassificationReader

class EntAugClassificationReader(ClassificationReader):
    """Classification Reader for input with entity-augmentaton."""

    def __init__(self, args):
        super(EntAugClassificationReader, self).__init__(args)
        return
    ...
    def _parse_src(self, src):
        ...
        field_values = super(EntAugClassificationReader, self)._parse_src(src)
