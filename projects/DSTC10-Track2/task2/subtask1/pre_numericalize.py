...
from ent_aug_classification_reader import EntAugClassificationReader
...
def setup_args():
    ...
    EntAugClassificationReader.add_cmdline_args(parser)
...
def main(args):
    ...
    reader = EntAugClassificationReader(args)
    reader.data_id = 0
