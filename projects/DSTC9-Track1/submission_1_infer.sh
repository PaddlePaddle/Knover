...
# download models
mkdir -p models
download_tar https://dialogue.bj.bcebos.com/Knover/projects/DSTC9-Track1/SOP-32L-Schema.tar models/SOP-32L-Schema
...
bash ./projects/DSTC9-Track1/task1/infer_with_schema.sh
